...
__all__ = [
    'SVP_3', 'SpeechFormatType', 'SPDKL_LocalMachine',
    'DISPID_SpeechLexicon', 'SAFTDefault',
    'DISPID_SpeechPhraseBuilder', 'SECFNoSpecialChars',
    'SPEI_HYPOTHESIS', 'DISPID_SPEActualConfidence',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpMMSysAudio',
    'SPRST_ACTIVE', 'SVPAlert', 'DISPID_SPAs_NewEnum',
    'DISPID_SRGetPropertyString', 'DISPID_SDKSetLongValue',
    'SPCT_COMMAND', 'DISPID_SVSPhonemeId', 'DISPID_SRGRules',
    'SpeechAudioFormatType', 'DISPID_SGRs_NewEnum', 'SPEI_MAX_SR',
    'DISPID_SpeechRecoResultTimes', 'SP_VISEME_16', 'SINoSignal',
    'DISPID_SPPConfidence', 'SpeechPropertyComplexResponseSpeed',
    'SVPOver', 'SPPROPERTYINFO', '_ISpeechVoiceEvents',
    'eWORDTYPE_DELETED', 'DISPID_SDKEnumKeys',
    'Speech_Max_Pron_Length', 'SPINTERFERENCE_TOOFAST',
    'SECNormalConfidence',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechObjectToken',
    'eLEXTYPE_PRIVATE3', 'SpResourceManager', 'SP_VISEME_7',
    'DISPID_SRCEHypothesis', 'SPAR_Medium', 'eLEXTYPE_PRIVATE12',
    'DISPID_SPAsCount', 'SREPropertyStringChange', 'SGLexical',
    'SPEI_PHRASE_START', 'ISpeechPhraseElement', 'SSSPTRelativeToEnd',
    'SRAImport', 'DISPID_SRCEStartStream', 'DISPID_SPAsItem',
    'SPVOICESTATUS', 'DISPID_SpeechLexiconProns',
    'DISPID_SOTCreateInstance', 'DISPID_SGRSAddSpecialTransition',
    'SAFTGSM610_8kHzMono', 'SPADAPTATIONRELEVANCE', 'SDTProperty',
    'SPDATAKEYLOCATION', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRSClsidEngine',
    'SGLexicalNoSpecialChars', 'DISPID_SGRSTsItem',
    'SPSERIALIZEDRESULT', 'SPEVENTENUM',
    'DISPID_SVSInputWordPosition', 'DISPID_SRRRecoContext',
    'SVSFUnusedFlags', 'SPEI_UNDEFINED', 'DISPID_SRState',
    'DISPID_SPRuleId', 'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE1',
    'SRSEIsSpeaking', 'SAFT24kHz8BitStereo', 'SPRECOCONTEXTSTATUS',
    'SDA_Two_Trailing_Spaces', 'DISPID_SLPsCount', 'SPLOADOPTIONS',
    'SDKLDefaultLocation', 'ISpeechObjectToken', 'DISPID_SGRsCount',
    'DISPID_SGRsCommit', 'SPEI_SR_RETAINEDAUDIO', 'SASStop',
    'SPVPRI_ALERT', 'SpeechTokenContext', 'SVP_14',
    'DISPID_SRCCmdMaxAlternates', 'SPINTERFERENCE_TOOSLOW',
    'SRTReSent', 'DISPID_SPEAudioStreamOffset', 'SGSExclusive',
    'DISPID_SPEPronunciation', 'SREPhraseStart', 'SRTExtendableParse',
    'SPXMLRESULTOPTIONS', 'SPAS_STOP', 'DISPID_SPPNumberOfElements',
    'DISPID_SVSLastBookmark', 'SpCompressedLexicon',
    'SpeechPropertyResourceUsage', 'SVP_7', 'SRESoundEnd',
    'ISpeechWaveFormatEx', 'SGPronounciation', 'SREAllEvents',
    'SVPNormal', 'DISPID_SBSWrite', 'DISPID_SPPId',
    'STSF_CommonAppData',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'DISPID_SOTId',
    'SREFalseRecognition', 'SPAUDIOSTATE', 'SP_VISEME_17',
    'ISpPhoneticAlphabetSelection', 'SPCS_DISABLED',
    'ISpeechPhoneConverter', 'DISPID_SVStatus', 'SPAUDIOSTATUS',
    'DISPID_SBSSeek', 'DISPID_SPPsItem', 'DISPID_SASNonBlockingIO',
    'SPSFunction', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVVolume', 'ISpRecoGrammar', 'SPGRAMMARWORDTYPE',
    'SP_VISEME_1', 'DISPID_SLGetGenerationChange',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SITooSlow', 'SLTUser',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechDataKey',
    'SAFTCCITT_uLaw_8kHzMono', 'SECFIgnoreWidth',
    'ISpObjectTokenCategory', 'SPPS_LMA', 'SpUnCompressedLexicon',
    'DISPID_SRGRecoContext', 'DISPID_SOTCDefault',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPCIdToPhone',
    'SVF_Stressed', 'SAFTCCITT_ALaw_11kHzMono',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SASCurrentSeekPosition',
    'SPSNotOverriden', 'SVSFIsFilename', 'SPPHRASERULE',
    'SpMemoryStream', 'SDTAll', 'SVP_6', 'SPPHRASEREPLACEMENT',
    'SPEI_TTS_BOOKMARK', 'SPPS_Function',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPIReplacements',
    'SPEI_RESERVED3', 'SPINTERFERENCE_NOISE', 'DISPID_SPIEngineId',
    'SPEI_RECO_OTHER_CONTEXT', 'SPSUnknown',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_MORPHOLOGY', 'ISpEventSink', 'SpCustomStream',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVEStreamStart',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPRsItem', 'SpStream',
    'SpSharedRecoContext', 'DISPID_SGRClear', 'ISpPhoneConverter',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRSAudioStatus',
    'IInternetSecurityMgrSite', 'DISPID_SRRTStreamTime',
    'SpeechVisemeType', 'DISPID_SRRTTickCount', 'eLEXTYPE_USER',
    'SPEI_MAX_TTS', 'SAFT11kHz8BitMono', 'SPEI_VISEME',
    'DISPID_SPIRule', 'SpeechRuleAttributes', 'SPPS_Noun',
    'DISPID_SPEsItem', 'SpeechRuleState', 'SPWT_PRONUNCIATION',
    'DISPID_SABIMinNotification', 'DISPID_SPEs_NewEnum',
    'eLEXTYPE_VENDORLEXICON', 'SASRun',
    'ISpPhoneticAlphabetConverter', 'DISPID_SLWsItem', 'SVSFIsNotXML',
    'STCLocalServer', 'ISpeechPhraseAlternate', 'SPPS_NotOverriden',
    'STSF_FlagCreate', 'SRSActive', 'SpeechMicTraining',
    'DISPID_SDKCreateKey', 'DISPID_SLPLangId', 'DISPID_SOTCId',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPCPhoneToId',
    'DISPID_SRCEventInterests', 'SPEVENT', 'DISPID_SRCPause',
    'SPPS_RESERVED1', 'DISPID_SRGDictationUnload',
    'SAFTGSM610_44kHzMono', 'DISPID_SRRecognizer', 'SPBO_NONE',
    'SpeechSpecialTransitionType', 'SPAR_Unknown', 'STCInprocHandler',
    'ISpDataKey', 'SPXRO_SML', 'SPLO_DYNAMIC', 'DISPIDSPTSI',
    'DISPID_SASFreeBufferSpace', 'SPWORDLIST',
    'DISPID_SpeechRecoContext', 'DISPID_SRRSaveToMemory', 'IStream',
    'IEnumString', 'DISPID_SDKGetBinaryValue',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPIAudioSizeTime', 'SpeechRunState',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SGRSTPropertyName', 'SPPS_Interjection',
    'SpeechRecognitionType', 'SPRULESTATE', 'DISPID_SGRAttributes',
    'Speech_StreamPos_Asap', 'ISpLexicon', 'DISPID_SOTDisplayUI',
    'ISpeechPhraseInfo', 'SAFT44kHz8BitStereo', 'SPPHRASE',
    'SGRSTTDictation', 'DISPID_SRRGetXMLErrorInfo',
    'eLEXTYPE_PRIVATE11', 'SP_VISEME_21', 'SGDisplay',
    'DISPID_SLRemovePronunciation', 'SPEI_SOUND_START',
    'SDTReplacement', 'DISPID_SRSetPropertyNumber',
    'SpeechCategoryPhoneConverters', 'DISPID_SRRSpeakAudio',
    'ISpeechPhraseReplacement', 'ISpeechLexiconPronunciations',
    'DISPID_SLPsItem', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPRuleParent', 'SFTSREngine', 'SPSNoun',
    'ISpeechXMLRecoResult', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SREmulateRecognition', 'DISPID_SVIsUISupported',
    'DISPID_SRCRecognizer', 'SAFTTrueSpeech_8kHz1BitMono',
    'SRERecoOtherContext', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVAlertBoundary', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SLWWord', 'ISpeechAudioStatus', 'DISPID_SAFGuid',
    'DISPID_SRCEPropertyStringChange',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPSHT_OTHER',
    'DISPID_SRCERecognition',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPPName',
    'ISpeechVoice', 'DISPID_SPIStartTime', 'DISPID_SPIProperties',
    'SAFT24kHz16BitStereo', 'DISPID_SVEWord',
    'DISPID_SPPBRestorePhraseFromMemory', 'SpeechAudioState',
    'SpWaveFormatEx', 'SRATopLevel', 'SPPS_RESERVED3',
    'ISpeechObjectTokenCategory', 'SpeechCategoryAppLexicons',
    'DISPID_SRRTOffsetFromStart', 'SVP_17', 'SVEEndInputStream',
    'SPRST_NUM_STATES', 'SGRSTTWildcard',
    'DISPID_SpeechLexiconPronunciation',
    'SpeechGrammarTagUnlimitedDictation', 'SAFT24kHz8BitMono',
    'SGDSActiveUserDelimited', 'SPPARTOFSPEECH', 'eLEXTYPE_RESERVED6',
    'ISpObjectToken', 'SPCATEGORYTYPE',
    'DISPID_SRSCurrentStreamNumber', 'SP_VISEME_0',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechVoice',
    'SREPropertyNumChange', 'SpSharedRecognizer', 'ISpeechBaseStream',
    'SpeechTokenValueCLSID', 'DISPID_SpeechFileStream',
    'SPRECORESULTTIMES', 'DISPID_SVSInputWordLength',
    'SPAO_RETAIN_AUDIO', 'DISPID_SGRSTText', 'DISPID_SGRSTPropertyId',
    'SpeechDisplayAttributes', 'SpeechRecoEvents', 'SVP_16',
    'SVSFPurgeBeforeSpeak', 'SREStreamStart', 'SPEI_RESERVED2',
    'DISPID_SRRAudio', 'DISPID_SpeechPhraseProperty',
    'ISpeechRecoResult2', 'DISPID_SRRAlternates',
    'SWPKnownWordPronounceable', 'SPRS_ACTIVE', 'SPEI_WORD_BOUNDARY',
    'DISPID_SVPause', 'SPFM_OPEN_READONLY', 'SPAS_PAUSE',
    'SpeechPropertyHighConfidenceThreshold', 'SP_VISEME_18',
    'DISPID_SRIsShared', 'SVF_Emphasis', 'SAFT8kHz16BitMono',
    'ISpeechPhraseReplacements', 'SpeechCategoryAudioIn',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRCVoicePurgeEvent',
    'SpeechRecognizerState', 'DISPID_SPRuleNumberOfElements',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRERecognition',
    'SpeechCategoryRecognizers', 'ISpeechAudioBufferInfo',
    'SPCT_SUB_DICTATION', 'DISPID_SRRSetTextFeedback',
    'SPWF_SRENGINE', 'SRTEmulated', 'DISPID_SDKSetBinaryValue',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRAudioInput',
    '_ISpeechRecoContextEvents', 'SRARoot',
    'DISPID_SRCERecognitionForOtherContext', 'ISpShortcut',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRAddState',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_3',
    'DISPID_SpeechGrammarRule', 'SPVISEMES', 'DISPID_SAStatus',
    'ISpeechPhraseRules', 'DISPID_SpeechPhraseInfo', 'SPPS_RESERVED4',
    'DISPID_SOTCategory', 'SAFTADPCM_8kHzStereo', 'SVSFParseSapi',
    'SpPhraseInfoBuilder', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SVSVisemeId', 'DISPID_SpeechPhoneConverter',
    'SAFT32kHz8BitMono', 'eLEXTYPE_PRIVATE20', 'SGDSInactive',
    'SpeechVoiceEvents', 'SAFTExtendedAudioFormat', 'DISPID_SLPType',
    'SpeechBookmarkOptions', 'DISPID_SGRId', 'DISPID_SVSkip',
    'SSTTTextBuffer', 'DISPID_SPACommit', 'DISPID_SVSpeak',
    'ISpEventSource', 'SP_VISEME_9', 'DISPID_SRCBookmark',
    'DISPID_SPEAudioSizeTime', 'SPEI_REQUEST_UI',
    'DISPID_SPPEngineConfidence', 'DISPID_SWFEExtraData',
    'SVSFParseAutodetect', 'SPSHT_Unknown', 'SREHypothesis',
    'SpeechPropertyResponseSpeed', 'SP_VISEME_19', 'SP_VISEME_20',
    'SpVoice', 'SpeechCategoryVoices', 'SECFIgnoreKanaType',
    'SPBINARYGRAMMAR', 'SWPUnknownWordPronounceable',
    'SRAORetainAudio', 'DISPID_SGRName', 'SAFT32kHz16BitMono',
    'DISPID_SLWType', 'DISPID_SRCVoice', 'DISPID_SAFGetWaveFormatEx',
    'SpShortcut', 'SAFTCCITT_uLaw_8kHzStereo',
    'ISpeechGrammarRuleStateTransition', 'SSSPTRelativeToStart',
    'SPEI_SR_BOOKMARK', 'tagSPPROPERTYINFO', 'SPGRAMMARSTATE',
    'DISPID_SPPsCount', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechRecoResult2', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechBaseStream', 'SVP_9', 'ISpeechAudio',
    'DISPID_SPRDisplayAttributes', 'SPXRO_Alternates_SML',
    'SWTDeleted', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SLPSymbolic', 'SpeechAllElements', 'SPWAVEFORMATTYPE',
    'SPPS_Noncontent', 'DISPID_SRCState', 'SPCONTEXTSTATE',
    'SPLEXICONTYPE', 'DISPID_SRSetPropertyString', 'WAVEFORMATEX',
    'ISpVoice', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechPhraseReplacements', 'SREBookmark', 'SRCS_Enabled',
    'SpeechEngineConfidence',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRTAutopause',
    'SAFT16kHz8BitMono', 'eLEXTYPE_RESERVED8',
    'SpeechGrammarTagDictation', 'SVP_5', 'ISequentialStream',
    'SPFM_NUM_MODES', 'DISPID_SLWsCount', 'SPWORDTYPE',
    'eLEXTYPE_APP', 'DISPID_SDKEnumValues', 'SPEVENTSOURCEINFO',
    'SPRECOGNIZERSTATUS', 'SpInprocRecognizer',
    'DISPID_SGRSTransitions', 'SPEI_PROPERTY_NUM_CHANGE', 'SVP_20',
    'SpeechWordType', 'DISPID_SMSADeviceId', 'SPBO_AHEAD',
    'DISPID_SPEDisplayText', 'SVP_12', 'LONG_PTR',
    'eLEXTYPE_RESERVED4', 'SPEI_END_SR_STREAM', 'SPFILEMODE',
    'SINoise', 'SITooQuiet', 'DISPID_SGRSTs_NewEnum', 'STSF_AppData',
    'ISpeechMemoryStream', 'DISPID_SpeechRecoResult',
    'DISPID_SRProfile', 'DISPID_SRCERequestUI',
    'DISPID_SRCEEnginePrivate', 'SPSVerb', 'DISPID_SASetState',
    'SPGS_EXCLUSIVE', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechLoadOption', 'DISPID_SPISaveToMemory', 'DISPID_SOTSetId',
    'SPPS_RESERVED2', 'SPRST_ACTIVE_ALWAYS',
    'IInternetSecurityManager', 'DISPID_SRGIsPronounceable',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SABIEventBias',
    'SPEI_SR_PRIVATE', 'DISPID_SASCurrentDevicePosition',
    'SAFTADPCM_44kHzStereo', 'SpNullPhoneConverter', 'SP_VISEME_5',
    'SPEI_START_SR_STREAM', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPSLMA', 'DISPID_SABIBufferSize', 'DISPID_SGRSAddWordTransition',
    'SPSHORTCUTPAIR', 'SPAR_Low', 'DISPID_SWFESamplesPerSec',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPIEnginePrivateData',
    'SPAO_NONE', 'SP_VISEME_8', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCEInterference', 'DISPID_SGRsDynamic', 'SRAONone',
    'DISPID_SpeechPhraseAlternates', 'SPPHRASEPROPERTY',
    'DISPID_SRRGetXMLResult', 'ISpRecognizer',
    'SpeechGrammarTagWildcard', 'ISpRecoContext2', 'ISpStream',
    'DISPID_SGRsAdd', 'SASClosed', 'DISPID_SDKOpenKey',
    'DISPID_SVSRunningState', 'DISPID_SVESentenceBoundary',
    'SVEWordBoundary', 'DISPID_SGRSTRule', 'DISPID_SADefaultFormat',
    'DISPID_SpeechPhraseRule', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFTADPCM_11kHzMono', 'SVSFParseSsml', 'ISpAudio',
    'DISPID_SPRs_NewEnum', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SOTsCount', 'eLEXTYPE_LETTERTOSOUND', 'SpeechDiscardType',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRGState',
    'eLEXTYPE_PRIVATE7', 'DISPID_SVEStreamEnd',
    'DISPID_SpeechAudioStatus', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRRTLength', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPRules_NewEnum', 'SSTTDictation', 'SRTStandard',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPEAudioSizeBytes',
    'SpMMAudioEnum', 'SPAS_CLOSED', '_SPAUDIOSTATE', 'SITooLoud',
    'SpInProcRecoContext', 'SVP_4', 'SPFM_OPEN_READWRITE',
    'SAFT24kHz16BitMono', 'SVEPrivate', 'eLEXTYPE_PRIVATE8',
    'SAFT12kHz16BitMono', 'DISPID_SPELexicalForm',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLGetWords',
    'DISPID_SPANumberOfElementsInResult', 'SDTPronunciation',
    'SPRST_INACTIVE_WITH_PURGE', 'Speech_Max_Word_Length',
    'SPEI_TTS_PRIVATE', 'SPGS_DISABLED', 'DISPID_SPRuleConfidence',
    'SPPHRASEELEMENT', 'SAFT16kHz16BitStereo', 'SPEI_SR_AUDIO_LEVEL',
    'SBOPause', 'SAFTADPCM_8kHzMono', 'SFTInput', 'SLTApp',
    'SPPS_Modifier', 'SAFT48kHz16BitMono', 'SPTEXTSELECTIONINFO',
    'SRSActiveAlways', 'SBONone', 'SRADynamic',
    'DISPID_SpeechPhraseAlternate', 'SP_VISEME_12',
    'DISPID_SPCLangId', 'DISPID_SOTsItem', 'DISPID_SPARecoResult',
    'SAFTNoAssignedFormat', 'DISPID_SPRulesItem',
    'SpeechInterference', 'SPCT_SUB_COMMAND', 'DISPID_SLWs_NewEnum',
    'SAFT22kHz8BitStereo', 'SAFTCCITT_ALaw_8kHzStereo',
    'SAFTADPCM_11kHzStereo', 'DISPID_SpeechGrammarRules',
    'ISpeechTextSelectionInformation', 'DISPID_SVVoice',
    'DISPID_SMSALineId', 'DISPID_SPRuleFirstElement',
    'eLEXTYPE_RESERVED10', 'SPBO_PAUSE', 'SREAdaptation',
    'SpeechStreamSeekPositionType', 'SpMMAudioIn',
    'Speech_StreamPos_RealTime', 'SP_VISEME_6', 'SPCT_DICTATION',
    'DISPID_SRCRetainedAudio', 'DISPID_SPRsCount',
    'eLEXTYPE_PRIVATE5', 'SpMMAudioOut', 'SpLexicon',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRSSupportedLanguages',
    'DISPID_SWFEChannels', 'SAFT16kHz8BitStereo', 'SP_VISEME_4',
    'DISPID_SABufferInfo', 'SAFTNonStandardFormat',
    ...
    'DISPID_SpeechWaveFormatEx', 'eLEXTYPE_PRIVATE9', 'SECFDefault',
    'SVP_2', 'ISpeechRecoResult', 'SSFMOpenForRead',
    'SVEStartInputStream', 'SREStateChange', 'SPBOOKMARKOPTIONS',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCResume',
    'SRADefaultToActive', 'DISPID_SRDisplayUI',
    'DISPID_SPRuleChildren', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpNotifySource', 'DISPID_SPRText', 'SVP_15', 'SVEBookmark',
    'DISPID_SpeechAudioBufferInfo', 'SVEPhoneme',
    'DISPID_SVEBookmark', 'ISpResourceManager', 'ISpRecoContext',
    'ISpSerializeState', 'SVP_0', 'DISPID_SLWLangId',
    'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE16', 'SPSEMANTICFORMAT',
    'DISPID_SOTCEnumerateTokens', 'SPSHORTCUTTYPE',
    'DISPID_SRGDictationSetState', 'SDKLCurrentUser',
    'SPSERIALIZEDPHRASE', 'SPEI_MIN_TTS',
    'DISPID_SPIAudioStreamPosition', 'SPEI_START_INPUT_STREAM',
    'SAFT44kHz16BitStereo', 'DISPID_SVWaitUntilDone',
    'SAFT22kHz16BitMono', 'SAFTGSM610_22kHzMono',
    'DISPID_SRIsUISupported', 'DISPID_SPPs_NewEnum',
    'DISPID_SOTDataKey', 'DISPID_SAVolume', 'SpeechEngineProperties',
    'DISPID_SVEPhoneme', 'SDKLLocalMachine', 'SAFTGSM610_11kHzMono',
    'DISPID_SLPPhoneIds', 'ISpeechGrammarRuleStateTransitions',
    'SECFIgnoreCase', 'SVSFNLPMask', 'SVSFVoiceMask',
    'SAFT48kHz8BitStereo', 'SAFT44kHz8BitMono', 'SREPrivate',
    'SP_VISEME_14', 'SPAR_High', 'DISPID_SAEventHandle',
    'ISpProperties', 'SAFT8kHz16BitStereo',
    'DISPID_SPRuleEngineConfidence', 'eLEXTYPE_PRIVATE14',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SLOStatic', 'DISPID_SRGCommit',
    'DISPID_SPEsCount', 'SSFMCreate', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPIRetainedSizeBytes',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SLPPartOfSpeech',
    'ISpeechPhraseAlternates', 'ISpRecognizer3',
    'DISPID_SPRNumberOfElements', 'SVEVoiceChange', 'SASPause',
    'SpFileStream', 'ISpeechRecognizerStatus',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVSpeakCompleteEvent',
    'ISpRecoCategory', 'DISPID_SRRAudioFormat',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRGSetTextSelection',
    'SVSFDefault', 'tagSPTEXTSELECTIONINFO', 'DISPID_SVRate',
    'DISPID_SLGetPronunciations', 'SVP_10',
    'SpPhoneticAlphabetConverter', 'SpeechLexiconType',
    'SAFTCCITT_ALaw_22kHzMono', 'SPSSuppressWord', 'SRTSMLTimeout',
    'SpeechGrammarWordType', 'SP_VISEME_2', 'SpeechAddRemoveWord',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SPERequiredConfidence',
    'eLEXTYPE_PRIVATE10', 'eLEXTYPE_USER_SHORTCUT', 'SPVPRIORITY',
    'SVP_13', 'DISPID_SpeechMemoryStream', 'SPGS_ENABLED',
    'SPEI_RESERVED1', 'DISPID_SRGDictationLoad', 'ISpeechRecoGrammar',
    'SPVPRI_OVER', 'SGRSTTRule', 'SDTLexicalForm',
    'DISPID_SDKSetStringValue', 'SpeechStreamFileMode', 'SPFM_CREATE',
    'ISpeechPhraseProperty', 'ISpPhraseAlt',
    'ISpeechGrammarRuleState', 'ISpPhrase', 'SDKLCurrentConfig',
    'SPCT_SLEEP', 'DISPID_SGRAddResource', 'SITooFast',
    'SAFT32kHz16BitStereo', 'SpeechVoiceSpeakFlags', 'SP_VISEME_15',
    'SDTAlternates', 'DISPIDSPRG', 'SAFT48kHz16BitStereo',
    'SPAUDIOOPTIONS', 'ISpeechLexicon', 'SPINTERFERENCE',
    'SSTTWildcard', 'DISPID_SGRSTWeight', 'DISPID_SLPs_NewEnum',
    'DISPID_SRCEAdaptation', 'SPRST_INACTIVE', 'DISPID_SRRTimes',
    'SPEI_RECOGNITION', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVResume', 'ISpGrammarBuilder', 'DISPID_SPRulesCount',
    'SpeechTokenKeyFiles', 'DISPID_SRCEEndStream',
    'DISPID_SVGetVoices', 'DISPID_SOTCSetId',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVP_21',
    'DISPID_SRGCmdSetRuleState', 'STCAll', 'eLEXTYPE_PRIVATE17',
    'SpeechAudioVolume', 'SVP_11', 'SDTRule',
    'SpeechWordPronounceable', 'DISPID_SGRsFindRule',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechVoiceSkipTypeSentence',
    'STSF_LocalAppData', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPRFirstElement', 'SPWORD', 'SPSMF_UPS',
    'DISPID_SOTRemove', 'SPSHT_NotOverriden', 'SAFT12kHz16BitStereo',
    'SAFT8kHz8BitMono', 'DISPID_SpeechLexiconWord', 'SPEI_MIN_SR',
    'ISpeechLexiconWords', 'ISpeechLexiconWord', 'SRCS_Disabled',
    'SPEI_SOUND_END', 'SDA_One_Trailing_Space', 'SP_VISEME_11',
    'DISPID_SGRSTType', 'DISPID_SRAudioInputStream',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_PRIVATE15',
    'SAFT12kHz8BitMono', 'SpAudioFormat', 'eLEXTYPE_PRIVATE13',
    'SpeechEmulationCompareFlags', 'DISPID_SDKDeleteValue',
    'DISPID_SFSClose', 'SpeechTokenIdUserLexicon',
    'DISPID_SGRSTPropertyValue', 'SRAExport',
    'DISPID_SRCERecognizerStateChange',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SOTGetDescription',
    'ISpRecognizer2', 'DISPID_SLGenerationId', 'DISPID_SVDisplayUI',
    'SDTAudio', 'SpeechCategoryAudioOut',
    'DISPID_SVAudioOutputStream', 'DISPID_SPEEngineConfidence',
    'SREStreamEnd', 'SpeechDataKeyLocation', 'ISpXMLRecoResult',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechVoiceStatus',
    'SAFT22kHz16BitStereo', 'SVP_1', 'DISPID_SRGetFormat',
    'SpeechPropertyAdaptationOn', 'SpeechPartOfSpeech', 'UINT_PTR',
    'DISPID_SPRuleName', 'SPVPRI_NORMAL',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SOTs_NewEnum',
    'DISPID_SVEVoiceChange', 'DISPID_SVEEnginePrivate',
    'SECFEmulateResult', 'DISPID_SRCESoundEnd',
    'DISPID_SOTIsUISupported', 'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechPhraseElement', 'SLODynamic', 'ISpObjectWithToken',
    'SpeechCategoryRecoProfiles', 'DISPID_SGRSRule',
    'SPSInterjection', 'DISPID_SRSCurrentStreamPosition',
    'SPFM_CREATE_ALWAYS', 'IEnumSpObjectTokens',
    'SpeechVoicePriority', 'ISpeechAudioFormat', 'SPWF_INPUT',
    'SGRSTTEpsilon', 'SRSInactive', 'ISpeechPhraseProperties',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechRecoContextState',
    'DISPID_SpeechAudio', 'DISPID_SVSLastStreamNumberQueued',
    'SpStreamFormatConverter', 'DISPID_SWFEFormatTag',
    'DISPID_SVGetAudioInputs', 'SAFTText', 'DISPID_SVPriority',
    'Speech_Default_Weight', 'ISpStreamFormat', 'SPRS_INACTIVE',
    'SAFTADPCM_22kHzMono', 'SECLowConfidence', 'SAFT16kHz16BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'SVEViseme', 'SDTDisplayText',
    'ISpeechFileStream', 'eWORDTYPE_ADDED', 'SPEI_ADAPTATION',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechAudioFormat',
    'SpNotifyTranslator', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechPhraseProperties', 'DISPID_SVSCurrentStreamNumber',
    'ISpNotifySink', 'SVEAudioLevel', 'DISPID_SPIAudioSizeBytes',
    'SP_VISEME_10', 'SpPhoneConverter',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPSEMANTICERRORINFO',
    'ISpeechDataKey', 'SGSEnabled', 'DISPID_SPPChildren',
    'DISPID_SVSLastResult', 'DISPID_SDKGetlongValue',
    'DISPID_SPPParent', 'DISPID_SRStatus', 'SAFTCCITT_uLaw_44kHzMono',
    'SWTAdded', 'SPEI_PHONEME', 'SAFTADPCM_22kHzStereo',
    'SPLO_STATIC', 'SWPUnknownWordUnpronounceable',
    'DISPID_SWFEAvgBytesPerSec', 'SPCS_ENABLED',
    'DISPID_SPAPhraseInfo', 'SPBO_TIME_UNITS',
    'DISPID_SpeechObjectTokens', 'DISPID_SFSOpen', 'DISPID_SBSRead',
    'SAFT12kHz8BitStereo', 'SAFT32kHz8BitStereo',
    'SPSMF_SAPI_PROPERTIES', 'SpeechAudioFormatGUIDWave',
    'SDA_Consume_Leading_Spaces', 'DISPID_SDKGetStringValue',
    'SpeechUserTraining', 'SpeechTokenKeyAttributes',
    'ISpeechLexiconPronunciation', 'SVSFlagsAsync',
    'SAFT8kHz8BitStereo', 'DISPID_SPPValue',
    'DISPID_SPERetainedSizeBytes', 'ISpeechPhraseElements',
    'DISPID_SLAddPronunciation', 'SPEI_RESERVED6', 'SpeechTokenKeyUI',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechXMLRecoResult',
    'SPPS_Unknown', 'DISPID_SDKDeleteKey', 'SDA_No_Trailing_Space',
    'DISPID_SABufferNotifySize', 'DISPID_SVSyncronousSpeakTimeout',
    'SPWT_LEXICAL', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCCreateGrammar',
    'SVSFPersistXML', 'SGRSTTWord', 'SRSEDone',
    'DISPID_SRCSetAdaptationData', 'SAFT48kHz8BitMono',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRCEBookmark',
    'DISPID_SPIGetText', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechRegistryUserRoot', 'SSFMOpenReadWrite',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVGetProfiles',
    'DISPID_SMSAMMHandle', 'SVP_19', 'SPEI_VOICE_CHANGE',
    'DISPID_SRRPhraseInfo', 'SPEI_RESERVED5', 'DISPID_SRGId',
    'SPEI_INTERFERENCE', 'SpeechGrammarRuleStateTransitionType',
    'SAFT44kHz16BitMono', 'DISPID_SPIElements', 'SpeechVisemeFeature',
    'ISpeechVoiceStatus', 'DISPID_SpeechPhraseRules',
    'SECHighConfidence', 'SPWORDPRONUNCIATION',
    'DISPID_SGRSTNextState', 'DISPID_SVAudioOutput', 'SGDSActive',
    'ISpNotifyTranslator', 'ISpeechRecoResultDispatch',
    'DISPID_SOTGetStorageFileName', 'ISpeechGrammarRules',
    'SRAInterpreter', 'DISPID_SCSBaseStream', 'SP_VISEME_13',
    'DISPID_SpeechLexiconWords', 'ISpeechRecoResultTimes',
    'ISpeechGrammarRule', 'DISPID_SOTCGetDataKey',
    'ISpeechObjectTokens', 'DISPID_SGRInitialState', 'SINone',
    'DISPID_SPPFirstElement', 'DISPID_SMSGetData', 'DISPID_SGRsItem',
    'DISPID_SGRsCommitAndSave', 'SpTextSelectionInformation',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRCESoundStart',
    'ISpeechPhraseRule', 'DISPID_SPEDisplayAttributes',
    'SPINTERFERENCE_TOOQUIET', 'SVESentenceBoundary', 'SPWT_DISPLAY',
    'DISPID_SOTGetAttribute', '_RemotableHandle', 'SVF_None',
    'eLEXTYPE_PRIVATE19', 'SREInterference', 'SRESoundStart',
    'SpObjectTokenCategory', 'DISPID_SRGCmdLoadFromMemory',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRGReset',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPDKL_CurrentConfig',
    'SpeechAudioProperties', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVEAudioLevel', 'STCInprocServer', 'ISpeechRecognizer',
    'SpeechRetainedAudioOptions', 'SVP_18',
    'DISPID_SpeechCustomStream', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPSHORTCUTPAIRLIST', 'SAFTADPCM_44kHzMono', 'eLEXTYPE_RESERVED9',
    'DISPID_SGRSTsCount', 'SVSFIsXML', 'DISPID_SpeechPhraseElements',
    'SGSDisabled', 'SVEAllEvents', 'SpeechGrammarState',
    'STCRemoteServer', 'DISPID_SPILanguageId',
    'DISPID_SpeechRecognizer', 'SPSTREAMFORMATTYPE',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechPhraseInfoBuilder',
    'SPPS_SuppressWord', 'SpObjectToken', 'SSFMCreateForWrite',
    'ISpeechResourceLoader', 'SPRULE', 'tagSTATSTG', 'ISpRecoResult',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPIGrammarId',
    '__MIDL_IWinTypes_0009', 'SPAS_RUN', 'DISPID_SVEViseme',
    'SPPS_Verb', 'SVSFParseMask', 'SPDKL_CurrentUser',
    'SAFT11kHz16BitStereo', 'DISPID_SPAStartElementInResult',
    'SRERequestUI', 'SPINTERFERENCE_NONE', 'DISPIDSPTSI_ActiveLength',
    'SPSModifier', 'DISPID_SBSFormat', 'SAFT11kHz8BitStereo',
    'SPRECOSTATE', 'DISPID_SLWPronunciations', 'DISPID_SAFType',
    'DISPID_SRCEPhraseStart', 'SGRSTTTextBuffer',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRGetRecognizers',
    'DISPID_SWFEBlockAlign', 'SpeechRecoProfileProperties',
    'SAFT11kHz16BitMono', 'SPINTERFERENCE_NOSIGNAL',
    'SAFT22kHz8BitMono', 'SREAudioLevel', 'SPDKL_DefaultLocation',
    'ISpeechMMSysAudio', 'eLEXTYPE_PRIVATE6', 'ISpeechRecoContext',
    'SVP_8', 'SpeechDictationTopicSpelling', 'ISpRecoGrammar2',
    'ISpeechCustomStream', 'SpeechTokenShellFolder',
